...
class FeatureConfigurationInputs(db.Model, MetaDataColumnsMixin):
    ...
    def __repr__(self):
        return f'<FeatureConfigurationInputs id="{self.featConfigId}" label="{self.label}" featModelId="{self.featModelId}">'  # noqa E501
